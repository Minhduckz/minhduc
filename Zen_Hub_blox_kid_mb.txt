...
loki.Image = "rbxassetid://11354741327"
...
--------------------------------------------------------------------
local Library = Update:Window("Mduc Hub","11354741327")
--------------------------------------------------------------------
...
local DevilFruit = Library:Tab("Fruit","rbxassetid://11446965348")
...
--------------------------------------------------------------------
Update:Notification("Hello, " ..game.Players.LocalPlayer.DisplayName.. " Welcome To Mduc Hub Mobile! Enjoy Using it! ")
...
Main:Button("Mink Fake Transform",function()
    require(game:GetService("ReplicatedStorage").Notification).new("Mink V4! / By : Mduc Hub"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Fishman V4! / By : Mduc Hub"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Skypeian V4! / By : Mduc Hub"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Ghoul V4! / By : Mduc Hub"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Cyborg V4! / By : Mduc Hub"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Human V4! / By : Mduc Hub"):Display();
    wait()
    setthreadcontext(5)
